...
//   });
// Becomes:
//   var result = yield Async.fromNode(FS.readdir)(x);
//   doStuff(result);
function fromNode(nodeFunc) {
  return function*(n_args) {
    const caller = yield;
...
exports.test = function() {
  ...
  call(function*() {
    ...
    try {
      var version = yield fromNode(FS.readFile)("JUNKFILE");
    } catch(e) {
      console.log("caught fromNode", e);
    }

    var FS = require("fs");
    var version = yield fromNode(FS.readFile)("LATEST");
